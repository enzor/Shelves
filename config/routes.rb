ActionController::Routing::Routes.draw do |map|
  ...
  map.author_login "author_login", :controller => 'author_sessions', :action => 'new'
  map.author_logout "author_logout", :controller => 'author_sessions', :action => 'destroy'
  
  map.resources :books

  map.resources :friendships

  map.resources :author_sessions
